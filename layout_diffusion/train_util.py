...
class TrainLoop:
    def __init__(
        ...
        self.opt = AdamW(
            self.mp_trainer.master_params, lr=self.lr, weight_decay=self.weight_decay, amsgrad=True
        )
        self.lr_anneal_steps = lr_anneal_steps if lr_anneal_steps > 0 else 100000
        self.scheduler = CosineAnnealingLR(self.opt, T_max=self.lr_anneal_steps, eta_min=0)
    ...
    def run_loop(self):
        ...
        for _ in tqdm(run_loop_generator()):
            ...
            batch = augmentation(batch)  # Apply augmentation
    ...
    def run_step(self, batch, cond):
        ...
        clip_grad_norm_(self.model.parameters(), max_norm=1.0)  # Add this line
